...
// Extensión del popover para abrir la vista de Gantt en renting
...
// Extensión del widget para actualizar los datos calculados en función de las fechas de renting
...
// Extensión del widget para definir dependencias de campos
