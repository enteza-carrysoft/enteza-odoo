...
`enteza_pedido_alquiler()` devuelve el **registro** y no un texto, para que la plantilla lo pinte
con `t-field` y sea Odoo quien aplique el huso: `rental_start_date` se guarda en UTC (11:00) y en
el papel tiene que verse en hora local (13:00).
